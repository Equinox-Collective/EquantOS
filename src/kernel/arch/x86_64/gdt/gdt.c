...
extern void gdt_flush(uint64_t); // Implemented in gdt_flush.asm
...
void init_gdt(void) {
    ...
    gdt.entries[1].granularity = 0x20; // Long mode (64-bit) flag
    ...
    gdt.entries[4].granularity = 0x20; // Long mode flag
